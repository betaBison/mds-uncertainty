...
class Simulator():
    ...
    def compute(self):
        ...
        S_full = torch.diag_embed(Q, dim1=0, dim2=2)
        print(S_full.shape)
        print(S_full[:,:,0])
